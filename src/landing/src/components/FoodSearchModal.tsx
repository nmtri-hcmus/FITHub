...
export const FoodSearchModal: React.FC<FoodSearchModalProps> = ({
  ...
  // In-session query cache: Map<query, results>
  ...
  const handleBarcodeFile = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (result?.getText()) {
        ...
        setBarcodeError('Could not detect barcode. Try a clearer photo.');
      }
    } catch {
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-text-subtle text-xs font-medium mt-0.5">
              ...
              {/* Barcode scanner — prominent labelled button */}
              <div>
                <input
                  ref={barcodeInputRef}
                  type="file"
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2.5 bg-surface border border-dashed border-surface-edge hover:border-primary/60 hover:bg-primary/5 text-text-muted hover:text-primary rounded-xl px-4 py-3 transition-all text-sm font-medium"
                >
                  {barcodeLoading ? (
                    <>
                      <div className="w-4 h-4 border-2 border-primary border-t-transparent rounded-full animate-spin" />
                      <span className="text-primary">Reading barcode...</span>
                    </>
                  ) : (
                    <>
                      ...
                      <span className="text-xs text-text-subtle">— point camera at product label</span>
                    </>
                  )}
                </button>
              </div>
              ...
              {barcodeError && (
                <p className="text-red-400 text-xs font-medium -mt-3">{barcodeError}</p>
              )}
                ...
                {showDropdown && (isSearching || displayedResults.length > 0 || hasSearched) && (
                  ...
                  >
                    {isSearching ? (
                      ...
                      // No results
                      <div className="flex flex-col items-center py-8 px-4 text-center gap-2">
              ...
              <AnimatePresence>
                {selected && (
                  ...
                  >
                    ...
                    {/* Macro preview tiles — live update with quantity */}
                    ...
                    <div className="flex items-center gap-4">
                      <label className="text-xs font-bold uppercase tracking-wider text-text-subtle whitespace-nowrap">
                        Servings
                      </label>
